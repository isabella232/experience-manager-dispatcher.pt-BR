...
seo-title: Invalidando páginas em cache do Adobe AEM
...
## Configuração AEM contas de usuário {#setting-up-aem-user-accounts}
...
Para obter mais informações, consulte a seção [Configurar usuários de replicação e transporte](https://helpx.adobe.com/experience-manager/6-3/sites/administering/using/security-checklist.html#VerificationSteps) da Lista de verificação de segurança do AEM.
...
* Evitar possíveis conflitos de tempo entre o Dispatcher e a instância de publicação (consulte [Invalidar o cache do Dispatcher a partir do Ambiente de Criação](#invalidating-dispatcher-cache-from-the-authoring-environment)).
