...
1. O Dispatcher encaminha a resposta para o navegador. O Dispatcher adiciona o corpo da mensagem de resposta da renderização ao cache.
...
## Implementação de cache sensível a permissão {#implementing-permission-sensitive-caching}
